...
<html lang="en">
    ...
    <body>
        <form action="forget">
            <div>
                <nav class="navbar navig">
                    ...
                    <h1>ParkEasy</h1>
                    <button class="nav-link1" type="submit" name="act" value="login">LOG IN</button> 
                </nav>
            </div>
            </form>
            <div style="background-image: url(images/blacky.jpg);height:98vh">
        ...
        <form class="form-container box" action="forget">
        <fieldset>
        <div class="inputbox" >
        ...
        <input type="password" name="repwd" required >
	        ...
	        <div>  
	        <button type="submit" class="btn bt" name="act" value="done">DONE</button>
	        </div>    
        </form>        
        </div>
        </div>
