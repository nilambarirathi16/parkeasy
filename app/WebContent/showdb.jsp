...
<html lang="en">
    <head>
        <title>Admin-->Show Database</title>
        <meta charset="utf-8">
        ...
        <form action="logout">
            <div>
                <nav class="navbar navig">
                    ...
                    <h1>ParkEasy</h1>
                    <button class="nav-link1" type="submit" value="logout">
                        <h5>Log Out</h5>
                    </button>
                </nav>
            </div>
          ...
          <form action="SHOWDB">
            <div style="background-image: url(images/blacky.jpg);height:75vh">
        ...
        <div class="row " style="border:2px solid transparent; display: flex; justify-content: center;">
            <div  class="col-xs-3 b"> <form class="form-container box">
                    <fieldset>
                        ...
                        <br>
                        <div class="inputbox">
                            <button type="submit" class="btn bt" name="act" value="collectshow">Daily Collection</button>
                        </div>
                        <br><br>
                        <div class="inputbox">
                            <button type="submit" class="btn bt" name="act" value="usershow">Users Statistics</button>
                        </div>
                        <br><br>             
                        <div class="inputbox">
                            <button type="submit" class="btn bt" name="act" value="slotshow">Slots Statistics</button>
                        </div>   
                        <br>                       
                    </form>
                </fieldset>
