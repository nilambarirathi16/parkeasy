                ...
                <div class="row " style="border:2px solid transparent; display: flex; justify-content: center;">
                    <div  class="col-lg-3 b">
                        <form class="form-group">
                            <fieldset>
                          		<div class="p">                       
                                	<p><h2>SLOT BOOKED!!</h2></p>
                                </div>
                                <div class="boxdisplay col-lg-3">
                                    <b><%= slot %></b>
                                </div>
                                <div class="inputbox" >
    						<center><h3>Address:</h3>
                                <div class="boxdisplay1">
                                 <%try 
                                 {			
							            Class.forName("com.mysql.jdbc.Driver");
							            Connection c=DriverManager.getConnection("jdbc:mysql://localhost:3306/parking","root","root");
							            Statement query=c.createStatement();
							            ResultSet rs=query.executeQuery("select location from loc where address='"+address+"'");
							            while(rs.next())
							            {
							            	%>
							        		<b><%=rs.getString(1) %></b>
                    ...
                    <div class="submit ">                            
                                    <button type="submit" class="btn bt">EXIT</button>
                            </div>
        	    </div>
        	</div>
        </div>
