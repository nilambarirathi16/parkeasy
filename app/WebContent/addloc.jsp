...
<html lang="en">
    ...
    %>
        <form action="logout">
            ...
            <form action="ADDLOC">
            <div style="background-image: url(images/blacky.jpg);height:94vh">
        ...
        <form class="form-container box">
        <fieldset>
        <form>  
        <div class="inputbox" >
        <label><b><h4>Location:</b></h4></label>
        <input type="text" name="location" required >
        </div>
         <div class="inputbox" >
        <label><b><h4>Address:</b></h4></label>
        <input type="text" name="locadd" required >
        </div>
        <div class="inputbox">
        <label><b><h4>**Enter the number of slots**</h4></b></label>
        </div>  
        <div class="inputbox" >
        <center>
        <label><b>2 Wheeler:</b></label><br>
        <input type="text" name="two" required >
        <br>
        <label><b>4 wheeler:</b></label><br>
        <input type="text" name="four" required >
        <br>
        <b><label>Others:</label><br>
        <input type="text" name="others" required ></b>
        </center>
        </div>
        </form>
        </fieldset>
        ...
        <footer>
            <center>
                ...
                <div>
                    ...
                    <p><a href="">support@parkeasy.com</a></p>
                </div>
